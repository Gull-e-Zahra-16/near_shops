  ...
  Future<void> _reactivateShop(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Shop reactivated successfully!'),
  ...
  Future<void> _sendReminder(
    ...
    try {
      await FirebaseFirestore.instance
        ...
        'type': 'reminder',
        'message':
            'Reminder: Please upload your platform fee receipt for ${shopData['shop_name']}.',
        'read': false,
        'createdAt': FieldValue.serverTimestamp(),
      });
 
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Reminder sent to shopkeeper!'),
