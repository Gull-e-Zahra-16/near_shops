...
class _AdminBillingScreenState extends State<AdminBillingScreen> {
  ...
  Future<void> _loadStats() async {
    ...
    for (var doc in billing.docs) {
      ...
      if (status == 'verified') revenue += (data['total_platform_fee'] ?? 0).toDouble();
          ...
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.monetization_on, color: kOrange, size: 26),
              ),
    ...
    final navItems = [
      {
        ...
        'color': kOrange,
        'screen': PaymentVerificationScreen()
      },
      {
        'label': 'Suspended Shops',
        'icon': Icons.block,
        'color': Colors.red,
        'screen': SuspendedShopsScreen()
      },
      {
        'label': 'Billing Workflow',
        'icon': Icons.account_tree_outlined,
        'color': kNavy,
        'screen': BillingWorkflowScreen()
      },
    ];
    ...
    return Container(
      ...
      child: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.store_outlined), label: 'Shops'),
